...
const SpecialtiesSection: React.FC = () => {
  return (
    <section className="flex justify-center items-center py-5 flex-col font-poppins ">
      ...
      <div className="flex flex-row justify-center items-center font-poppins text-xs md:text-sm lg:text-base">
        <div
          className="
          flex
          flex-row
        ...
        >
          <div className="flex flex-col text-center justify-center items-center ">
            ...
            <div className="justify-start items-baseline text-center">
              <h1 className="text-sm md:text-lg font-semibold">S.O Linux</h1>
            </div>
          ...
          <div className="flex flex-col text-center justify-center items-center ">
            ...
            <div className="justify-start items-baseline text-center">
              <h1 className="text-sm md:text-lg font-semibold">Data Science</h1>
            </div>
            <p className="w-4/5 mt-2">
          ...
          <div className="flex flex-col text-center justify-center items-center ">
            ...
            <div className="justify-start items-baseline text-center">
              <h1 className="text-sm md:text-lg font-semibold">Pentest</h1>
            </div>
            <p className="w-4/5 mt-2">
          ...
          <div className="flex flex-col text-center justify-center items-center ">
            ...
            <div className="justify-start items-baseline text-center">
              <h1 className="text-sm md:text-lg font-semibold">Terminal</h1>
            </div>
            <p className="w-4/5 mt-2">
