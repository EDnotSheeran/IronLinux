    ...
    <Layout>
      ...
      <section className="container mx-auto lg:px-0">
        ...
        <div className="mb-20">
          ...
          <p className="text-xl leading-7 text-center text-gray-700 px-16">
            Por mais de 2 anos, a IronLinux tem ajudado organizações de
            diferentes escalas e estruturas a melhorar e modernizar suas
            estratégias de TI. Alguns de nossos especialistas em TI trabalharam
            no setor por mais de cinco anos. Isso nos permitiu criar uma
            abordagem eficaz para consultoria de TI que nos permite oferecer o
            máximo benefício no menor tempo possível.
          </p>
        </div>
        <div className="flex flex-wrap gap-20 mb-20">
          ...
          <div className="flex-1 bx-shaddow rounded-md p-9 min-w-80">
            ...
            />
            <p className="font-medium text-center text-grey mt-10 leading-7">
              Os consultores projetam um roteiro e uma estratégia que ajudará
              sua empresa a aproveitar as tecnologias mais recentes e
              desorganizar sua infraestrutura de software.
            </p>
          </div>
          <div className="flex-1 bx-shaddow rounded-md p-9 min-w-80">
            <h3 className="text-xl text-grey-500 font-semibold mb-10 text-center">
